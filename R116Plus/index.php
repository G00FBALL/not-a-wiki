...
<div class="shlisting">
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Artifact Set</b>: Dragon, Druid (If FC12 and R108 power add up to x1000+)
                      <p><button onclick="myFunction($(this))">Copy Build</button>
               ...
               <div class="shelementwhole">
                   ...
                   <div class="autohide">
                      ...
                      <div class="shelementwhole">
                          <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Fairyline Druid (Outdated?)<font color="DarkGoldenRod"> Neutral</font></a></b></p>
                          <div class="autohide">
                      ...
                      <div class="shelementwhole">
                          ...
                          <div class="autohide">
                              ...
                              <p><b>Artifact Set</b>: Titan
                                    ...
                                    <p><button onclick="myFunction($(this))">Copy Build</button>
                                    <input type="text" value="S300,S1450,S3200,C251,C340,C375,C1300,C1500,D245,D350,D1125,E275,E1225,E1425,A250,A1200,W260,W1375,W1400" id="Build"> A250
                              <p>S300,S1450,S3200,
    ...
    <div class="category">
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Faceline Titans (Lantern Of Guidance)<font color="DarkGoldenRod"> Neutral</font></a></b></p>
            <div class="autohide">
                              <p><b>Author</b>: ?
    ...
    <div class="shelementwhole">
        ...
        <div class="autohide">
            ...
            <p><b>Artifact Set</b>: Dwarf
                  ...
                  <p><button onclick="myFunction($(this))">Copy Build</button>
                  <input type="text" value="S50,S400,S435,C175,D200,C250,D560,E1,E135,E225,E495,E590,A10,A120,A410,W25,W205,W405,W520" id="Build"> 1e53 (100 Sxd) gems+ Lineage Building
            <p>S50,S400,S435,
            <p>C175,C340,
            <p>D200,D560,
...
<div class="shelementwhole">
    ...
    <div class="category">
    <div class="shelementwhole">
        <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">General Lineage Leveler(L30)<font color="DarkGoldenRod"> Neutral</font></a></b></p>
        <div class="autohide">
    <p><b>Author</b>: ?
    <p><b>Range</b>: 1e51 (1 Sxd)
    <p><b>Faction</b>: Faceless/Dragon
    <p><b>Bloodline</b>: Fairy/Elf/Angel/Goblin/Undead/Demon/Titan/Druid/Dwarf/Drow
    <p><b>Artifact Set</b>: Titan (Angel, Goblin and Titan Lineage)
    <p><b>Artifact Set</b>: Druid (Elf, Demon and Druid Lineage)
    ...
    <p><b>Artifact Set</b>: Dragon (Dwarf and Drow Lineage)
          ...
          <p><button onclick="myFunction($(this))">Copy Build</button>
          <input type="text" value="S251,S375,S400,S1450,S1500,C400,C1300,D200,D260,D1125,E320,E350,E1225,A300,A1200,A3400,W275,W1375,W1400" id="Build"> Goblin Lineage
          <p><button onclick="myFunction($(this))">Copy Build</button>
          <input type="text" value="S251,S375,S400,S1450,S1500,C400,C1300,D260,D330,D1125,E145,E350,E1225,A300,A1200,A3400,W275,W1375,W1400" id="Build"> D330
    ...
    <p><b>Notes</b>: Swap E145 with E320 when leveling Goblin Lineage or if goblin AH is avaliable.
    <p><b>Notes</b>: Swap D200 with D330 if Druid AH is available and is at least 95%, or if leveling anything but Titan and Undead and able to be always online.
    <p><b>Notes</b>: Leveling Undead to L30 first is fastest.
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Druid</b>: 1e64 (10 Vg)
                <p><b>Faceless</b>: 1e67 (10 UVg)
                <p><b>Faction</b>: Goblin/Drow
    ...
    <p><b>Artifact Set</b>: Dwarf
          ...
          <p><button onclick="myFunction($(this))">Copy Build</button>
          <input type="text" value="S1,S180,S400,S590,C10,C400,C405,C520,D200,D225,D435,E50,E320,E410,A30,A120,A495,W560,W1375" id="Build"> Goblin AH is avaliable
          <p><button onclick="myFunction($(this))">Copy Build</button>
          <input type="text" value="S1,S180,S400,S590,C10,C400,C405,C520,D225,D245,D435,E50,E400,E410,A30,A120,A495,W560,W1375" id="Build"> 1e64 (10 Vg) Gems+
          <p><button onclick="myFunction($(this))">Copy Build</button>
          <input type="text" value="S1,S180,S400,S590,C10,C400,C405,C520,D225,D245,D435,E50,E145,E410,A30,A120,A495,W560,W1375" id="Build"> 1e65 (100 Vg) Gems+
    <p>S1,S180,S400,S590,
    <p>C10,C400,C405,C520,
    <p>D200,D225,D435,
    <p>E50,E145,E410,
    <p>A30,A120,A495,
    <p>W560,W1375
    <p><b>Notes</b>: Swap E145 with E320 if Goblin AH is avaliable.
    <p><b>Notes</b>: Swap D200 to D245 and E145 to E400 to be able to afford DN12 with 1e64 (10 Vg) Gems+.
    <p><b>Notes</b>: Swap E400 back to E145 at 1e65 (100 Vg) Gems+.
    <p><b>Notes</b>: Use Goblin lineage leveler at 1e67 (10 UVg) Gems+.
         </div>
    </div>
    <div class="shelementwhole">
        <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Fairy (L30+)(Outdated?)<font color="DarkRed"> Evil</font></a></b></p>
        <div class="autohide">
    <p><b>Author</b>: Artcrow
    <p><b>Requirement</b>: Fairy Lineage Level 30+
    ...
    <p><b>Artifact Set</b>: Undead
          ...
          <p><button onclick="myFunction($(this))">Copy Build</button>
          <input type="text" value="S225,S400,S435,C400,D25,D330,D560,E10,E320,E495,A1,A175,A400,A410,A590,W50,W205,W405,W520" id="Build"> Goblin AH is avaliable.
    <p>S225,S400,S435,
    <p>C400,
    <p>D25,D330,D560,
    <p>E10,E145,E495,
