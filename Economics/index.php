...
<head>
    <?php include "../scripts/header.html"; ?>
        ...
        <p><b>Faction Coin Formula</b>: floor(1.5 * x ^ 1.05)%, where x is Playtime (This Game in minutes).</p>
        <p><b>Royal Exchange Formula</b>: floor(x^0.6)%, where x is Playtime (This Game in minutes).</p>
        <hr>
        ...
        <p><b>Additive Formula</b>: (x ^ 0.2), where x is tax collections (This game)</p>
        <p><b>Multiplicative Formula</b>: (0.85 * x ^ 0.15), where x is tax collections (This game)</p>
        <hr>
