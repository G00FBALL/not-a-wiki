...
<div class="shlisting">
    ...
    <div class="shelementwhole">
        ...
        <div class="autohide">
            ...
            <p><b>Notes</b>: Rush build, used for buffing W275 before merc research unlock.
            <p><b>Notes</b>: Excavate for DB5, no GB tiers/additional targets needed
     </div>
</div>
        <div class="shelementwhole">
    ...
    <div class="category">
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Range</b>: 1e87 (1 Ocvg) Gems
                <p><b>Faction</b>: Neutral Mercenary
                <p><b>Bloodline</b>: Elf First then other 11
                <p><b>A2950</b>: Dragon
                <p><b>Range</b>: 1e87 (10 OcVg) gems - 1e96 (1 UTg) gems
                  <p><button onclick="myFunction($(this))">Copy Build</button>
                  ...
                  <p><button onclick="myFunction($(this))">Copy Build</button>
                  <input type="text" value="EL1,EL3,EL7,AN3,AN5,AN6,GB7,DD3,DD6,FC7,FR9,DG4,SP:Fairy Chanting,SP:Dragon's Breath,S215,S305,S400,S500,S1450,S1500,C250,C340,C400,C590,C1300,C1325,D25,D200,D275,D290,D1275,D1375,E135,E320,E350,E590,E1225,E1425,A105,A120,A305,A545,A1325,A1500,W150,W180,W275,W400,W1375,W1400" id="Build"> All others
                  <p><button onclick="myFunction($(this))">Copy Build</button>
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Faction</b>: Neutral Mercenary
                <p><b>Bloodline</b>: Drow First then other 11
                <p><b>A2950</b>: Dragon
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Notes</b>: Swap Moon Blessing with Brainwave if MB is lower than T3
         </div>
    </div>
        <div class="shelementwhole">
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>13th Upgrade</b>: UD7
                  ...
                  <p><button onclick="myFunction($(this))">Copy Build</button>
                  <input type="text" value="EL3,AN2,AN5,AN9,TT6,DD5,DD7,DN2,DN8,DG3,DG4,DG9,SP:God's Hand,SP:Fairy Chanting,S50,S215,S305,S1450,S1500,S3200,C340,C400,C590,C1300,C1500,C3000,D25,D275,D290,D1275,D1375,D2775,E10,E135,E230,E1225,E3250,E3300,A120,A410,A545,A1500,A2950,A3400,W180,W205,W400,W525,W3050,W3150" id="Build"> No GB10
    ...
    <div class="category">
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Notes</b>: Only GB10 is needed, get GB11 for mazimizing prod
