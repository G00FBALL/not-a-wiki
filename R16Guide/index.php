...
<p>RPs increase by the number of the R, so if R16 had a max of 136 RPs, R17 has 136+17=153, <a href="http://musicfamily.org/realm/Researchtree/></a>the research tree page</a> has the max number of RPs for all Rs between R16-R100, along with the total cost of all RPs you can buy at each R. (assuming you already have the max RPs for the previous R)</p>
