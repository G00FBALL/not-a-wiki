...
<head>
    <?php include "../scripts/header.html"; ?>
        ...
        <p><img src="http://musicfamily.org/realm/Factions/picks/Mercenary.png" align="middle"><b>  Champion Trophy</b></p>
        ...
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade1.png" align="middle"> Mercenary Upgrade 1</b></p>
        ...
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade2.png" align="middle"> Mercenary Upgrade 2</b></p>
        ...
        <p><b>Formula</b>: (0.5 * ((1 + 0.8 * x) ^ (0.5 + 0.05 * A) - 1)), where x is amount of spells cast in this game and A your Ascension.</p>
        <p><b>Effect</b>: Increase clicking reward by 100% per active spell.</p>
		<p><b>Formula</b>: ((x * 100) ^ (A + 1))%, where x is the amount of active spells you have and A your Ascension.</p>
        <br/>
        ...
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade5.png" align="middle"> Mercenary Upgrade 5</b></p>
        <p><b>Cost</b>: 3,000 FC</p>
        <p>Pick an available Tier 2 Upgrade from existing factions.</p>
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade6.png" align="middle"> Mercenary Upgrade 6</b></p>
        <p><b>Cost</b>: 6,000 FC</p>
        <p>Pick an available Tier 2 Upgrade from existing factions.</p>
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade7.png" align="middle"> Mercenary Upgrade 7</b></p>
        <p><b>Cost</b>: 10,500 FC</p>
        <p>Pick an available Tier 2 Upgrade from existing factions.</p>
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade8.png" align="middle"> Mercenary Upgrade 8</b></p>
        ...
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade9.png" align="middle"> Mercenary Upgrade 9</b></p>
        <p><b>Cost</b>: 4,500 FC</p>
        <p>Pick an available Tier 3 Upgrade from existing factions.</p>
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade10.png" align="middle"> Mercenary Upgrade 10</b></p>
        <p><b>Cost</b>: 10,500 FC</p>
        <p>Pick an available Tier 3 Upgrade from existing factions.</p>
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade11.png" align="middle"> Mercenary Upgrade 11</b></p>
        <p><b>Cost</b>: 16,500 FC</p>
        <p>Pick an available Tier 3 Upgrade from existing factions.</p>
        <p>The available choices will depend on the alignment and spells you have chosen.</p>
        <br/>
        <p><b><img src="http://musicfamily.org/realm/Factions/picks/MercenaryUpgrade12.png" align="middle"> Mercenary Upgrade 12</b></p>
