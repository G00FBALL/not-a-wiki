...
<head>
    ...
    <div class="category">
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b><a href="#" onclick="return false;">Cyden's unnecessarily complicated guide to a profitable Dragon unlock</b></a></p>
            <div class="autohide">
    ...
    <p><b>Stage 2</b>:Choose 1 of these two builds below</p>
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Bloodline</b>: Druid</p>
                  <p><button onclick="myFunction($(this))">Copy Build</button>
                  <input type="text" value="FR1,FR9,AN3,AN5,AN8,DD4,DD6,DD8,FC2,FC5,FC7,DN2,SP:God's Hand,SP:Hellfire Blast" id="Build"></p>
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Bloodline</b>: Druid</p>
                  <p><button onclick="myFunction($(this))">Copy Build</button>
                  <input type="text" value="FR9,AN3,AN5,AN6,AN8,UD3,UD5,DM8,DD6,FC7,DN2,DW2,SP:God's Hand,SP:Hellfire Blast" id="Build"></p>
