...
<div class="shlisting">
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
                    <p onclick="shohid($(this));"><b><a href="#" onclick="return false;"> Titan (SS2)<font color="DarkGoldenRod"> Neutral</font></a></b></p>
                                <div class="autohide">
                <p><b>Author</b>: Artcrow
                <p><b>Faction</b>: Titan
                <p><b>Bloodline</b>: Druid
                ...
                <p>W150,W180,W290,W320,W330,W400
                <p><b>Notes</b>: Requires 6 hours to unlock SS6. Swap S500 with S400 if higher.
                <p>Also used for stage 4 unlock at e31 (10 No) gems (requires using S400 with at least 14k bonus, estimated run time 10 hours)
         </div>
    </div>
            </div>
                    <br/>
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b><a href="#" onclick="return false;"> Dragon Stage 4 <font color="Blue">Good</font></a></b></p>
            <div class="autohide">
                <p><b>Author</b>: Artcrow
                <p><b>Faction</b>: Titan
                <p><b>Bloodline</b>: Druid
