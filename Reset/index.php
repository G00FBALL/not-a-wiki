...
<p><b> Gems to Coins Formula</b>: n * (n + 1) * 5e11(5e3 in A2, 5e18 in A4), where n is gems</p>
<p><b> Coins to Gems Formula</b>: floor(((1 + 4 * n / 5e11(5e3 in A2, 5e18 in A4)) ^ 0.5 - 1) / 2), where n is coins</p>
