...
<div class="shlisting">
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Fairy Rusher<font color="Blue"> Good</font></a></b></p>
            <div class="autohide">
                <p><b>Author</b>: Artcrow
                <p><b>Range</b>: 1e27 (1 Oc) - 1e33 (1 Dc) Gems
                <p><b>Faction</b>: Fairy
                <p><b>Bloodline</b>: Undead
                <p><b>Artifact Set</b>: Fairy
                      <p><button onclick="myFunction($(this))">Copy Build</button>
                      <input type="text" value="S1,S180,S3200,C10,C340,D225,D245,E50,E1325,A30,A120,W1375" id="Build">
                      <p><button onclick="myFunction($(this))">Copy Build</button>
                      <input type="text" value="S1,S180,S3200,C10,C340,D225,D245,E50,E400,A30,A120,W1375" id="Build"> R115
                <p>S1,S180,S3200,
                <p>C10,C340,
                <p>D225,D245,
                <p>E50,E1325,
               ...
               <div class="shelementwhole">
                   ...
                   <div class="autohide">
                       ...
                       <p>A250,A300,
                       <p>W275,W1375
                       <p><b>Notes</b>: Takes estimated time of 45 minutes - 2 hours to SS7.
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p><b>Artifact Set</b>: Druid, Faceless (if stronger)
                      <p><button onclick="myFunction($(this))">Copy Build</button>
                      <input type="text" value="S251,S375,S400,C340,D245,D260,E350,E1425,A250,A300,W275,W1375" id="Build">
                <p>S251,S375,S400,
                <p>C340,
                <p>D245,D260,
                <p>E350,E1425,
                <p>A250,A300,
                <p>W275,W1375
                <p><b>Notes</b>: Takes estimated time of 45 minutes - 1.5 hours to SS7.
                <p><b>Notes</b>: Do W275 buffing before running this build.
                </div>
    </div>
        <div class="shelementwhole">
