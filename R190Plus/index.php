    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p>F5500</p>
                <p><b>Notes</b>: Only needs to be run once at some point before A4. Increases combo strike count primarily through DJC1 and Drow challenge reward. <b>DO NOT</b> recast fairy chanting; instead, update its duration by exporting your save and reimporting it. This prevents the DJC1 effect from being reset. Benefits from buffing s5375 and d5625; one strategy is buffing s5375 and d5625 (fairy faction last) at r206 while gaining time for neutral,evil,order, and balance, and running this build for the last day to complete the Mercenary Challenge 5 requirement and buff DWP1 simultaneously. Recommended value to aim for is ~300%(?)</p>
            </div>
        </div>
        <br/>
        <div class="shelementwhole">
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                ...
                <p>F5250</p>
                <p><b>Notes</b>: Tested after Mercenary Challenge 5, with ~6h this R/3h evil</p>
