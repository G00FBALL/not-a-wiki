...
<p>Each Faction has its own unique and universal Heritage that you can unlock and buy in each subsequent abdication.
<p>To unlock them, you need to unlock the <p><b><a href="http://musicfamily.org/realm/FactionChampion/"> Champion Trophy</a></b> of that faction, which requires buying every Faction Upgrade of that Faction. 
<p>Once unlocked, its price is in Faction Coins, the number depending on the faction's tier: 
<p><b>Vanilla</b>: 5000
<p><b>Neutral</b>: 25000 of two factions
<p><b>Prestige</b>: 75000
<p><b>Neutral Prestige</b>: 400b of Dwarf and Drow
<p><b>Mercenary</b>: 100000 of all.
<p><b>----------------------------------</b>
...
<p><b>Formula</b>: floor(7.5 * log(1+x))%, where x is the amount of gems you have.
<p><b>----------------------------------</b>
...
<p><b>Effect</b>: You gain additional assistants based on the time spent in this game.
<p><b>Formula</b>: floor(1 + 1.5 * x^0.5), where x is your Playtime (This Game) stat in hours.
<p><b>----------------------------------</b>
...
<p><b>Effect</b>: Your production is increased based on the highest amount of buildings purchased in a single game.
<p><b>Formula</b>: 0.25 * x^0.75%, where x is your Buildings Owned (Max) stat.
<p><b>----------------------------------</b>
...
<p><b>Effect</b>: Increase the production of all buildings based on the highest amount of coins you gained in a single game.
<p><b>Formula</b>: floor(5 * log(1 + x)), where x is your Coins Gained (Max) stat.
<p><b>----------------------------------</b>
