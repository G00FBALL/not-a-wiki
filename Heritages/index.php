...
<head>
	<?php include "../scripts/header.html"; ?>
		...
		<p><b><img src=http://musicfamily.org/realm/Factions/picks/AngelicHeritage.png alt=Angelic Heritage align=middle> Angelic Heritage</b></p>
		...
		<p><b><img src=http://musicfamily.org/realm/Factions/picks/DemonicHeritage.png alt=Demonic Heritage align=middle> Demonic Heritage</b></p>
		...
		<p><b><img src=http://musicfamily.org/realm/Factions/picks/DragonHeritageFactionUpgrade.png alt=Dragon Heritage align=middle> Dragon Heritage</b></p>
		...
		<p><b>Formula</b>: (0.025 * (x * (1 + y)) ^ 0.65)%, where x is current excavations and y is ruby and free excavation resets this R.</p>
			" coords="10,190,64,244" shape="rect">
		...
		<p><b>Formula</b>: (2 * ln(1 + x) ^ 2)%, where x is your chance to find faction coins.</p>
		<br/>
		<p id="ANH"><img src="http://musicfamily.org/realm/Factions/picks/AngelicHeritage.png" alt="Angelic Heritage" align="middle"><b> Angelic Heritage</b></p>
		<p><b>Cost</b>: 5,000 Angel Coins</p>
		<p><b>Requirements</b>: Angel Champion Trophy</p>
		<p><b>Effect</b>: Multiplicatively increase Mana Regeneration by 10%.</p>
		<br/>
		...
		<p><b>Formula</b>: +(floor(1 + 1.6 * (x / 3600) ^ 0.6)), where x is time spent this game.</p>
		<br/>
		<p id="DMH"><<img src="http://musicfamily.org/realm/Factions/picks/DemonicHeritage.png" alt="Demonic Heritage" align="middle"><b> Demonic Heritage</b></p>
		<p><b>Cost</b>: 5,000 Demon Coins</p>
		<p><b>Requirements</b>: Demon Champion Trophy</p>
		<p><b>Effect</b>: Increase the production of all buildings by 0.3% per Hall of Legends you own.</p>
		<br/>
		...
		<p><b>Formula</b>: floor(5 * log10(1 + x))%, where x is your Coins Gained (Max) stat.</p>
		<br/>
		<p id="DGH"><<img src="http://musicfamily.org/realm/Factions/picks/DragonHeritageFactionUpgrade.png" alt="Dragon Heritage" align="middle"><b> Dragon Heritage</b></p>
		<p><b>Cost</b>: 400 B (4e11) Dwarven and Drow coins</p>
		<p><b>Requirements</b>: Dragons Champion Trophy</p>
		<p><b>Effect</b>: Increase assistants production based on time spent affiliated with Dragons in this Reincarnation.</p>
		<p><b>Formula</b>: (0.3 * x ^ 0.7)%, x is time in seconds affiliated with Dragons (This Reincarnation).</p>
		...
		<p><b>Formula</b>: (0.25 * ln(1 + x) ^ 2)%, where x is amount of clicks this reincarnation.</p>
		<br/>
		<p id="ANAH"><<b><img src="http://musicfamily.org/realm/Factions/picks/AdvancedAngelicHeritage.png" align="middle"> Advanced Angelic Heritage</b></p>
		<p><b>Cost</b>: 1 Sp (1e24) Angel Coins</p>
		<p><b>Requirements</b>: Angel Master trophy and 8 hours activity time (This Game) of God's Hand.<p>
		<p><b>Effect</b>: Increase mana regeneration based on the amount of spells cast in this game.</p>
		<p><b>Formula</b>: +(5 * x ^ 0.25), where x is spells cast this game.</p>
		...
		<p><b>Formula</b>: (0.025 * ln(1 + x) ^ 2)%, where x is offline bonus multiplier.</p>
		<br/>
		<p id="DMAH"><<b><img src="http://musicfamily.org/realm/Factions/picks/AdvancedDemonicHeritage.png" align="middle"> Advanced Demonic Heritage</b></p>
		<p><b>Cost</b>: 1 Sp (1e24) Demon Coins</p>
		<p><b>Requirements</b>: Demon Master trophy and 8 hours activity time (This Game) of Hellfire Blast.<p>
		<p><b>Effect</b>: Increase the production of all buildings based on trophies unlocked.</p>
		<p><b>Formula</b>: (0.25 * x ^ 0.75)%, where x is amount of trophies unlocked.</p>
