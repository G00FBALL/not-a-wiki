...
<head>
    ...
    <div id="tiercal" style="padding-left: 70px">
        ...
        <div class='container' id='app'>
            <br/>
            <b class='page-header'>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspWhat Tiers do you have unlocked?</b>
...
<!--                <button id='doReEnter' class='btn btn-success' type='button'>Re-Enter save</button>
                ...
                <div class='panel-body'>
                    <div class='input-group panelSaveInput'>
                        <label id='saveInputLabel' class='input-group-addon' for='saveInput'><b>Input Save</b>
                            <input id='saveInput' class='form-control' type='text' name='saveInput' value=''> <button id='doSaveClear' class='btn btn-danger' type='button' >Clear save</button>
                    </div>
                </div>
            </div>
            <ul>
        ...
        <div class="container">
            <div class="panel-group" id="merc">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <b class="panel-title">
                            <a data-toggle="collapse" data-parent="#tier" href="#collapse0"></a>
                                ...
                                <div class="container">
                                    <div class="panel-group" id="accordion">
                                        <div class="panel panel-default">
                                            <div class="panel-heading">
                                                <b class="panel-title">
                                                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseCTATier"><b>Call to Arms Tier 2-6</b></a>
                                                </b>
                                            </div>
                                            <div id="collapseCTATier" class="panel-collapse collapse">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseSSTier"><b>Spiritual Surge Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseSSTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
                        ...
                        <p><b>Cost</b> 4.356 Qaqag (4.356e135) - <b>FC</b> 631 Qi (6.31e20)
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseHLTier"><b>Holy Light Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseHLTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseBFTier"><b>Blood Frenzy Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseBFTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Tier Formula</b>: ^1.5 for tier 2, ^1.75 for tier 3, ^2.00 for tier 4,^2.25 for tier 5
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseGGTier"><b>Gem Grinder Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseGGTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Challenge Upgrade</b>: Fairy Orchestra, Each assistant generates 3 times as many faction coins while Fairy Chanting is active.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseFCTier"><b>Fairy Chanting Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseFCTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Challenge Upgrade</b>: Star Blessing, Clicks from the Sun Blessing spell upgrade have a 5% increased chance to trigger Elven (3,2) Elven Luck.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseMBTier"><b>Moon Blessing Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseMBTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Challenge Upgrade</b>: God's Throne, Mana regeneration is increased by 20% while God's Hand is active.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseGHTier"><b>God's Hand Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseGHTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Challenge Upgrade</b>: Iron Grip, Increase Diamond Pickaxe duration by 8 seconds, and its bonus to Faction Coin find chance is passively applied as a multiplier to excavations Faction Coin rewards.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseDPTier"><b>Diamond Pickaxe Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseDPTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Challenge Upgrade</b>: Avarice Drive, Increase Goblin's Greed duration by 5 seconds.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseGGTiers"><b>Goblin's Greed Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseGGTiers" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Formula</b>: 0.2 * x^0.7%, where x is your Time Spent Offline (Total) stat in seconds.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseNTTier"><b>Night Time Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseNTTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Formula</b>: floor(0.25 * x), where x is the amount of trophies unlocked.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseHBTier"><b>Hellfire Blast Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseHBTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>New Combo Strike Counter Formula</b>: C - Ctax, where C is your Spells Cast (This Game) stat and Ctax is your Tax Collection Cast This Game.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseCSTier"><b>Combo Strike Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseCSTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Formula</b>: round(x^0.8)%, where x is your current chance to find Faction Coins.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseLSTier"><b>Lightning Strike Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseLSTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Tier Upgrade</b>: +10 minutes per tier of Brainwave past tier 1.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseBTier"><b>Brainwave Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseBTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b>Formula</b>: floor (x^0.2 / 10), where x is your Mana Produced (Total) stat.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseGBTier"><b>Grand Balance Tier 2-6</b></a>
                        </b>
                </div>
                <div id="collapseGBTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <p><b><img src="http://musicfamily.org/realm/Factions/picks/DragonsBreath.png" alt="Neutral" align="middle"> Dragons Breath</b> (Any Neutral Dragon)</p>
                    ...
                    <p><b>Challenge Upgrade</b>: Prismatic Breath While all 5 breaths are active, Reincarnations count double for all purposes.
                    <p><a data-toggle="collapse" data-parent="#accordion,#accordion1" href="#collapseDBTier"><b> Dragons Breath Tier2-6</b></a>
                        </b>
                </div>
                <div id="collapseDBTier" class="panel-collapse collapse">
                    <div class="panel-body">
                        </b>
