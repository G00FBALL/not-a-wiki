...
<?php include "../scripts/header.html"; ?>
		...
		<table class="imgtable">
			<tr>
				<td>
					...
					<center><img src="http://musicfamily.org/realm/Factions/picks/LegacyMenu.png" usemap="#Legacy-map"></center>
				</td>
				<td>
					<center>Legacy Combo Menu</center>
					<center><img src="http://musicfamily.org/realm/Factions/picks/LegacyComboMenu.png" usemap="#Combo-map"></center>
				</td>
			</tr>
		</table>
	</center>
	<map name="Legacy-map">
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FairyUpgrade3.png' align='middle'><b> Fairy Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: +(1.3 * x ^ 0.7), where x is the amount of Good buildings you own.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FairyUpgrade6.png' align='middle'><b> Fairy Silver Legacy</b></p>
	...
	<p><b>Formula</b>: +(2.75 * x ^ 0.275), where x is the number of Blacksmiths you own.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FairyUpgrade9.png' align='middle'><b> Fairy Gold Legacy</b></p>
	...
	<p><b>Formula</b>: +(1.2 * x ^ 0.6), where x is the number of Farms, Inns, and Blacksmiths you own.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FairyUpgrade12.png' align='middle'><b> Fairy Diamond Legacy</b></p>
	...
	<p><b>Formula</b>: (1.2 * x ^ 0.8)%, where x is Chaos spells cast this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/ElvenUpgrade3.png' align='middle'><b> Elven Bronze Legacy</b></p>
	<p><b>Elven Mint</b></p>
	...
	<p><b>Formula</b>: +(2 * log10(1 + x) ^ 1.25), where x is the amount of clicks made in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/ElvenUpgrade6.png' align='middle'><b> Elven Silver Legacy</b></p>
	...
	<p><b>Formula</b>: (2 * x ^ 0.4)%, where x is your Treasure Clicks all time.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/ElvenUpgrade9.png' align='middle'><b> Elven Gold Legacy</b></p>
	...
	<p><b>Effect</b>: Additively increase base clicking reward by 50% of your building production.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/ElvenUpgrade12.png' align='middle'><b> Elven Diamond Legacy</b></p>
	<p><b>Wooden Dice</b></p>
	...
	<p><b>Formula</b>: (1.5 * log10(1 + x) ^ 1.5)%, where x is Faction Coins found this game (multiplicatively).</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/AngelUpgrade3.png' align='middle'><b> Angel Bronze Legacy</b></p>
	<p><b>Holy Bells</b></p>
	...
	<p><b>Formula</b>: +(10 * x)%, where x is the amount of active spells.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/AngelUpgrade6.png' align='middle'><b> Angel Silver Legacy</b></p>
	...
	<p><b>Effect</b>: Increase Mana Regeneration multiplicatively by 50%.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/AngelUpgrade9.png' align='middle'><b> Angel Gold Legacy</b></p>
	...
	<p><b>Formula</b>: (4 * ln(1 + x) ^ 2)%, where x is your Mana Regeneration.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/AngelUpgrade12.png' align='middle'><b> Angel Diamond Legacy</b></p>
	...
	<p><b>Effect</b>: Multiplicatively increase Maximum Mana, Mana Regeneration, Faction Coin find chance and assistants by 200%.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/GoblinUpgrade3.png' align='middle'><b> Goblin Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: +(x ^ 0.5), where x is the amount of buildings you own.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/GoblinUpgrade6.png' align='middle'><b> Goblin Silver Legacy</b></p>
	...
	<p><b>Formula</b>: (12 * ln(1 + x) ^ 3)%, where x is the seconds of your Tax Collection.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/GoblinUpgrade9.png' align='middle'><b> Goblin Gold Legacy</b></p>
	...
	<p><b>Formula</b>: (randRange(1 , 2500) * x), where x is your total (buildings + assistants) coin production per second, <b>including spells</b>.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/GoblinUpgrade12.png' align='middle'><b> Goblin Diamond Legacy</b></p>
	<p><b>Fool's Gems</b></p>
	...
	<p><b>Formula</b>: (x ^ 0.65)%, where x is the amount of buildings of the same tier. </p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/UndeadUpgrade3.png' align='middle'><b> Undead Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: +(x ^ 0.3), where x is the highest amount of Necropolises you built in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/UndeadUpgrade6.png' align='middle'><b> Undead Silver Legacy</b></p>
	...
	<p><b>Formula</b>: (125 * ln(1 + x) ^ 2.5)%, where x is your Mana Regeneration.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/UndeadUpgrade12.png' align='middle'><b> Undead Diamond Legacy</b></p>
	...
	<p><b>Formula</b>: +(21 * x ^ 0.7), where x is offline time in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DemonUpgrade3.png' align='middle'><b> Demon Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: (4 * x ^ 0.8)%, where x is the highest amount of Hell Portals you built in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DemonUpgrade6.png' align='middle'><b> Demon Silver Legacy</b></p>
	<p><b>Lava Pits</b></p>
	...
	<p><b>Formula</b>: +(6 * x ^ 0.4), where x is Evil spells cast this game.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DemonUpgrade9.png' align='middle'><b> Demon Gold Legacy</b></p>
	...
	<p><b>Formula</b>: (4 * x ^ 0.8)%, where x is the highest amount of Hell Portals you built in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DemonUpgrade12.png' align='middle'><b> Demon Diamond Legacy</b></p>
	...
	<p><b>Formula</b>: (2.5 * ln(1 + x) ^ 2.5)%, where x is your Mana Regeneration.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/TitanUpgrade3.png' align='middle'><b> Titan Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: +(3 * x ^ 0.7)%, where x is time spent as Neutral in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/TitanUpgrade6.png' align='middle'><b> Titan Silver Legacy</b></p>
	<p><b>Titan Drill</b></p>
	...
	<p><b>Formula</b>: (20 + 2.15 * ln(1 + x) ^ 2.15)%, where x is the amount of assistants you own.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/TitanUpgrade9.png' align='middle'><b> Titan Gold Legacy</b></p>
	...
	<p><b>Formula</b>: (6 * x ^ 0.6)%, where x is the amount of Hall of Legends built.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/TitanUpgrade12.png' align='middle'><b> Titan Diamond Legacy</b></p>
	...
	<p><b>Formula</b>: +(25 * x ^ 0.7), where x time spent as Order in this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DruidUpgrade3.png' align='middle'><b> Druid Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: (0.4 x ^ 0.4), where x is total buildings built. (additively and multiplicatively)</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DruidUpgrade6.png' align='middle'><b> Druid Silver Legacy</b></p>
	...
	<p><b>Formula</b>: +(1.3 * x ^ 0.7), where x is the amount of assistants you own.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DruidUpgrade9.png' align='middle'><b> Druid Gold Legacy</b></p>
	<p><b>Mabinogion</b></p>
	...
	<p><b>Formula</b>: (1.5 * x ^ 0.9)%, where x is the amount of buildings of the same type.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DruidUpgrade12.png' align='middle'><b> Druid Diamond Legacy</b></p>
	...
	<p><b>Formula</b>: (0.8 * ((6 - abs(6 - T)) ^ 4))%, where T is building tier.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FacelessUpgrade3.png' align='middle'><b> Faceless Bronze Legacy</b></p>
	...
	<p><b>Formula</b>: (0.3 * x ^ 0.7)%, where x is your Playtime (Longest Session) stat this Reincarnation.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FacelessUpgrade6.png' align='middle'><b> Faceless Silver Legacy</b></p>
	...
	<p><b>Formula</b>: (0.8 * x ^ 0.8)%, where x is your Buildings Owned (Max) stat.</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FacelessUpgrade9.png' align='middle'><b> Faceless Gold Legacy</b></p>
	...
	<p><b>Formula</b>: (x ^ 0.5)%, where x is total time spent as Faceless (all time).</p>
		...
		<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/FacelessUpgrade12.png' align='middle'><b> Faceless Diamond Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DwarvenUpgrade3.png' align='middle'><b> Dwarven Bronze Legacy</b></p>
	<p><b>Dwarven Ale</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DwarvenUpgrade6.png' align='middle'><b> Dwarven Silver Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DwarvenUpgrade9.png' align='middle'><b> Dwarven Gold Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DwarvenUpgrade12.png' align='middle'><b> Dwarven Diamond Legacy</b></p>
	<p><b>Solidity</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DrowUpgrade3.png' align='middle'><b> Drow Bronze Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DrowUpgrade6.png' align='middle'><b> Drow Silver Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DrowUpgrade9.png' align='middle'><b> Drow Gold Legacy</b></p>
	<p><b>Spider Gods</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DrowUpgrade12.png' align='middle'><b> Drow Diamond Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DragonUpgrade3.png' align='middle'><b> Dragon Bronze Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DragonUpgrade6.png' align='middle'><b> Dragon Silver Legacy</b></p>
	<p><b>Dragonborn</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DragonUpgrade9.png' align='middle'><b> Dragon Gold Legacy</b></p>
	...
	<area research="
	<p><img src='http://musicfamily.org/realm/Factions/picks/DragonUpgrade12.png' align='middle'><b> Dragon Diamond Legacy</b></p>
	<p><b>Fang Food</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/MysticForest.png' align='middle'><b> Mystic Forest</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/SacredGlade.png' align='middle'><b> Sacred Glade</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/GoldenHeaven.png' align='middle'><b> Golden Heaven</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/DreamRealm.png' align='middle'><b> Dream Realm</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/ArtifactCaveau.png' align='middle'><b> Artifact Caveau</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/EternalBattlefield.png' align='middle'><b> Eternal Battlefield</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/GreedFactory.png' align='middle'><b> Greed Factory</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/FrozenWastes.png' align='middle'><b> Frozen Wastes</b></p>
	...
	<p><img src='http://musicfamily.org/realm/Factions/picks/CorruptionZone.png' align='middle'><b> Corruption Zone</b></p>
	...
	<hr>
	<p id="FR-EL"><img src="http://musicfamily.org/realm/Factions/picks/MysticForest.png" align="middle"><b> Mystic Forest</b></p>
	<p><b>Requirement</b>: Fairy Legacy, Elf Legacy</p>
	<p><b>Effect</b>: Increase the production of all buildings based on the amount of assistants you own.</p>
	<p><b>Formula</b>: (2 * ln(1 + x) ^ 2)%, where x is the amount of assistants you own.</p>
	<hr>
	<p id="FR-AN"><img src="http://musicfamily.org/realm/Factions/picks/DreamRealm.png" align="middle"><b> Dream Realm</b></p>
	<p><b>Requirement</b>: Fairy Legacy, Angel Legacy</p>
	<p><b>Effect</b>: Increase Mana Regeneration based on time spent as Good in this Reincarnation.</p>
	<p><b>Formula</b>: (0.7 * x ^ 0.7)%, where x is time spent as Good in this Reincarnation.</p>
	<hr>
	<p id="FR-GB"><img src="http://musicfamily.org/realm/Factions/picks/ArtifactCaveau.png" align="middle"><b> Artifact Caveau</b></p>
	<p><b>Requirement</b>: Fairy Legacy, Goblin Legacy</p>
	<p><b>Effect</b>: Increase the production of all buildings based on artifacts found.</p>
	<p><b>Formula</b>: (x ^ 0.95)%, where x is the number of artifacts found.</p>
	<hr>
	...
	<p><b>Formula</b>: (2.4 * x ^ 0.4)%, where x is the amount of clicks made in this game.</p>
	<hr>
	<p id="EL-GB"><img src="http://musicfamily.org/realm/Factions/picks/GreedFactory.png" align="middle"><b> Greed Factory</b></p>
	<p><b>Requirement</b>: Elf Legacy, Goblin Legacy</p>
	<p><b>Effect</b>: Multiplicatively increase Faction Coin find chance based on Tax Collections casts in this game.</p>
	<p><b>Formula</b>: (2.5 * ln(1 + x) ^ 2.5)%, where x is the amount of Tax Collection casts in this game.</p>
	<hr>
	<p id="EL-UD"><img src="http://musicfamily.org/realm/Factions/picks/SwampofSorrows.png" align="middle"><b> Swamp of Sorrows</b></p>
	<p><b>Requirement</b>: Elf Legacy, Undead Legacy</p>
	<p><b>Effect</b>: Activity time of all spells counts more based on Maximum Mana.</p>
	<p><b>Formula</b>: (2 * ln(1 + x) ^ 2.25)%, where x is your Maximum Mana.</p>
	<hr>
	...
	<p><b>Note</b>: 'Clicks count more' effects are <b>not</b> affecting this upgrade.</p>
	<hr>
	<p id="AN-GB"><img src="http://musicfamily.org/realm/Factions/picks/GoldenHeaven.png" align="middle"><b> Golden Heaven</b></p>
	<p><b>Requirement</b>: Angel Legacy, Goblin Legacy</p>
	<p><b>Effect</b>: Increase the production of all buildings based on Gold owned.</p>
	<p><b>Formula</b>: (log10(1 + x) ^ 2)%, where x is the current amount of Gold you own.</p>
	<hr>
	<p id="AN-UD"><img src="http://musicfamily.org/realm/Factions/picks/DarkSanctum.png" align="middle"><b> Dark Sanctum</b></p>
	<p><b>Requirement</b>: Angel Legacy, Undead Legacy</p>
	<p><b>Effect</b>: Multiplicatively increase Maximum Mana based on time spent as Order in this Reincarnation.</p>
	<p><b>Formula</b>: (0.7 * x ^ 0.7)%, where x is time spent as Order in this Reincarnation.</p>
	<hr>
	<p id="AN-DM"><img src="http://musicfamily.org/realm/Factions/picks/EternalBattlefield.png" align="middle"><b> Eternal Battlefield</b></p>
	<p><b>Requirement</b>: Angel Legacy, Demon Legacy</p>
	<p><b>Effect</b>: Increase the production of Evil Buildings based on time spent as Good in this Reincarnation, and vice-versa. Does not affect Neutral Buildings</p>
	<p><b>Formula</b>: (0.7 * x ^ 0.7)%, where x is time spent as Good/Evil in this Reincarnation.</p>
	<hr>
	...
	<p><b>Formula</b>: (1.3 * x ^ 0.7)%, where x is the sum of your unspent research budget across all branches.</p>
	<hr>
	<p id="GB-DM"><img src="http://musicfamily.org/realm/Factions/picks/CorruptionZone.png" align="middle"><b> Corruption Zone</b></p>
	<p><b>Requirement</b>: Goblin Legacy, Demon Legacy</p>
	<p><b>Effect</b>: Increase the production of Non-Unique buildings based on the duration of your longest spell.</p>
	<p><b>Formula</b>: (0.8 * x ^ 0.8)%, where x is the duration of your longest spell.</p>
	<hr>
	<p id="UD-DM"><img src="http://musicfamily.org/realm/Factions/picks/FrozenWastes.png" align="middle"><b> Frozen Wastes</b></p>
	<p><b>Requirement</b>: Undead Legacy, Demon Legacy</p>
	<p><b>Effect</b>: Increase Offline Production based on time spent offline in this Reincarnation.</p>
	<p><b>Formula</b>: (0.7 * x ^ 0.7)%, where x is time spent offline in this Reincarnation.</p>
