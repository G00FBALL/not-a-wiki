...
<head>
    <?php include "../scripts/header.html"; ?>
        ...
        <p><b>Formula</b>: (0.5 * (T ^ 1.5) * (x ^ 0.5)%, where x is the highest amount of Burning Abysses built this Reincarnation, T is building tier.</p>
        <p></p>
        ...
        <p><b>Formula</b>: (x ^ 0.7)%, where x is the highest amount of Mountain Palaces you built this Reincarnation.</p>
        <p></p>
        ...
        <p><b>Formula</b>: (0.5 * x ^ 0.5)%, where x is the highest amount of Ziggurats built this Reincarnation.</p>
        <p></p>
		<p><b>Lunar Cycle</b></p>
        ...
        <p><b>Formula</b>: (2 * ln(1 + x) ^ 2)%, where x is highest max mana this R.</p>
			" coords="190,500,244,544" shape="rect">
		</map>
		<map name="Combo-map">
