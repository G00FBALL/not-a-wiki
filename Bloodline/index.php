    ...
    <?php include "../scripts/header.html"; ?>
        ...
        <p>
            ...
            <map name="Bloodlines-map">
                ...
                <area href="#Elf" research="<p><img src=http://musicfamily.org/realm/Factions/picks/ElvenBloodline.png align=middle> <b>Elven</b></p><p><b>Effect</b>: Increase the chance to find Faction Coins based on Faction Coins found in this game.</p><p><b>Effect</b>: Autoclick 3 times per second. Autoclicks made this way benefit from a 100 times higher clicking reward and Faction Coin find chance.</p><p><b>Formula</b>: (10 * ln(1 + x) ^ 1.75), where x is number of Faction Coins found in this game.</p><p><b>Effect</b>: Also multiplicatively increase Faction Coin find chance based on the amount of clicks made in this game.</p><p><b>Formula</b>: (10 * floor(log10(1 + x)), where x is clicks made in this game.</p>" coords="78,21,126,68" shape="rect">
