...
<p>The Dragon Faction appears in addition to a Neutral faction, this enables the player to use all the 2 faction spells and 18 upgrades and from both the Neutral and Dragon factions.</p>
...
<p><b><font color="darkgreen">Formula</b></font>: Formula: (0.01 * x^0.625 * (11-T)^5)%, where x is spells cast (this game) and T is the building tier. (1 for Farms, 11 for Hall of Legends).
...
<p><b>Description</b>: The Dragon is the mightiest, most imposing creature of all the realms. None may stand a chance alone against a Dragon, not even the fiercest of heroes. They usually care little for the lower creatures, but you have piqued their interest.
<p><b>Requirement</b>: Dragon Tamer Trophy, any Neutral alliance
...
<p><b>Formula</b>: ({0.75 * (t ^ 0.55)}%) where t is amount of time spent with 
...
<p><b><img src="http://musicfamily.org/realm/Factions/picks/SharpClawsFactionUpgrade.png" alt="Smiley face" align="middle"> SharpClaws</b></p>
<p><b>Requirement</b>: Dragons Friendship Pact
<p><b>Cost</b>: 5 Tvg (5e72 DC)</p>
<p><b>Effect</b>: Gain additional assistants based on clicks made in this game.</p>
<p><b>Effect</b>: Assistants also produce 0.125 m/s each.</p>
<p><b>----------------------------------</b></p>
...
<p><b>Formula</b>: ({100 * ((x + 1) ^ 2)}%) where x is amount of active Dragon's Breath effects.
<p><b>----------------------------------</b></p>
...
<p><b>----------------------------------</b></p>
<p><img src="http://musicfamily.org/realm/Factions/picks/DragonUniqueBuilding.png" alt="Unique building drow" align="middle"></p>
