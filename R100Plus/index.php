...
<div class="shlisting">
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                    ...
                    <p><b>Artifact Set</b>: Elf
                      <p><button onclick="myFunction($(this))">Copy Build</button>
                      <input type="text" value="S175,S3200,C1,C225,C400,D50,D290,E25,E3250,A120,W10,W1375">
                    <p>S175,S3200,
                    <p>C1,C225,C400,
                    <p>D50,D290,
                    <p>E25,E3250,
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                    ...
                    <p><b>Artifact Set</b>: Elf
                      <p><button onclick="myFunction($(this))">Copy Build</button>
                      <input type="text" value="S175,S3200,C1,C225,C340,D50,D1375,E25,E3250,A250,W10,W1375">
                    <p>S175,S3200,
                    <p>C1,C225,C340,
                    <p>D50,D1375,
                    <p>E25,E3250,
    ...
    <div class="category">
        ...
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Arboreal City (Elf) 1e27 (1 Oc) Gems<font color="Blue"> Good</font></a></b></p>
            <div class="autohide">
                    <p><b>Author</b>: ensteffahn
        ...
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Slave Market (Goblin) 1e27 (1 Oc) Gems<font color="DarkRed"> Evil</font></a></b></p>
            <div class="autohide">
                    <p><b>Author</b>: ensteffahn
                    <p><b>Range</b>: 1e27 (1 Oc) Gems
        ...
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Flesh Workshop (Undead) 1e27 (1 Oc) Gems<font color="DarkRed"> Evil</font></a></b></p>
            <div class="autohide">
                    <p><b>Author</b>: ensteffahn
                    <p><b>Range</b>: 1e27 (1 Oc) Gems
        ...
        <div class="shelementwhole">
            ...
            <div class="autohide">
                    ...
                    <p>A251,A375,A400,
                    <p>W350,W1375
                    <p><b>Notes</b>: Estimated 12 hours to unlock.
                    <p><b>Notes</b>: Swap C340 with C400 if you own T7 spells, which will also allow unlock in 2 hours.
        </div>
    </div>
        <div class="shelementwhole">
            <p onclick="shohid($(this));"><b> <a href="#" onclick="return false;">Forbidden Library (Faceless) 1e27 (1 Oc) Gems<font color="DarkGoldenRod"> Neutral</font></a></b></p>
            <div class="autohide">
                    <p><b>Author</b>: ensteffahn
                    <p><b>Range</b>: 1e27 (1 Oc) Gems
