...
<head>
    <?php include "../scripts/header.html"; ?>
        ...
        <h6>Forbidden Facilities</h6>
        <p><img src="http://musicfamily.org/realm/Factions/picks/Forbiddenr.png" alt="Forbiddenr" align="middle"> <b>Forbidden</b></p>
        <p>Take advantage of the most ancient and secret arts to empower your production beyonds known limits.</p>
        <p><b>Increases</b>: <b>Mercenary</b> production.</p>
        <p>Pointing to this ingame will tell you your total/spent research points.(R175+)</p>
        <br/>
