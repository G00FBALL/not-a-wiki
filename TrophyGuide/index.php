...
<head>
    ...
    <p><b>Clouded</b>
    <p>Register with the cloud
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/Rule'disSecretTrophy.png" alt="Rule 'dis" align="middle"> <b>Rule ’dis</b>
    <p>Abdicate 10 times within 3 minutes.(yes just spam abdication)
    ...
    <p>No gem power allowed (and really overpowered for the first dozen abdications) so you may as well get this right out of the gate.
    <p>Quite easy by following this <a href="http://musicfamily.org/realm/SpeedRun/"><b>guide</b></a>.
    <p><b>Effect</b>: Increase your base clicking reward by 1m.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/NeedaHeadStartSecretTrophy.png" alt="Need a Head Start?" align="middle"> <b>Need a Headstart?</b>
    <p>Don’t do anything for 5 minutes after abdicating or reincarnating.
    ...
    <p>Import this “glho kohhl snod” without the "" (has no effect on game; clues come from Faceless upgrades)
    <p><b>Effect</b>: Increase base clicking reward by 1.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/LeetSecretTrophy.png" alt="Leet" align="middle"> <b>Leet</b>
    <p>Have exactly 1337 Coins at any given time. Buy 1 farm, and click slowly after 1250 coins.
    <p><b>Note</b>: This sometimes does not work, just click 1337 times to get the trophy.
    <p><b>Effect</b>: Increase the production of all buildings by 1.337%
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/BecauseILiketoGrindSecretTrophy.png" alt="Because I Like to Grind" align="middle"> <b>Because I Like to Grind</b>
    <p>Spend at least 3 hours playing the game.
    <p><b>Effect</b>: Increase Royal Exchange bonus by an additional 1%.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/BuildingHaterSecretTrophy.png" alt="Building Hater" align="middle"> <b>Building Hater</b>
    <p>Reach 100000 Coins without building anything. (12 clicks with Speed Run, ~3000 without)
    <p><b>Effect</b>: Increase clicking reward by 25%
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/AssistantSquasherSecretTrophy.png" alt="Assistant Squasher" align="middle"> <b>Assistant Squasher</b>
    <p>Click an assistant icon (near the middle of the game background) 100 times.
    <p><b>Effect</b>: Instantly add 1 additional assistant.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/AdvisorInsightSecretTrophy.png" alt="AdvisorInsight" align="middle"> <b>Advisor Insight</b>
    <p>Click the Hint button (Lady) bottom right 100 times.
    <p><b>Effect</b>: Increase the production of all buildings by 10%.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/SpellfurySecretTrophy.png" alt="Spellfury" align="middle"> <b>Spellfury</b> (easy with Angels and all upgrades)
    <p>Cast Tax Collection while having 3 spells active.
    <p><b>Effect</b>: Increase Mana production by 5%.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/God'sRestSecretTrophy.png" alt="Gods Rest" align="middle"> <b>God’s Rest</b>
    <p>Cast God’s Hand (Angel spell) on any Sunday.(6am to 6pm)
    ...
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/SunBlessingSecretTrophy.png" alt="Sun Blessing" align="middle"> <b>Sun Blessing</b>
    <p>Cast Moon Blessing (Elf spell) between 6 am and 12 pm (noon).(based on your local time)
    <p><b>Effect</b>: The treasure is autoclicked 15 times per second while Moon Blessing is active.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/TrueNightSecretTrophy.png" alt="True Night" align="middle"> <b>True Night</b>
    <p>Cast Night Time (Undead spell) between 11 pm and 6 am.(based on your local time)
    <p><b>Effect</b>: Increase Night Time boost to assistants production to 40% per Necropolis.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/GrandDiplomatSecretTrophy.png" alt="Grand Diplomat" align="middle"> <b>Grand Diplomat</b>
    <p>Ally with each vanilla faction at least once.
    <p>Elf, Fairy, Angel, Goblin, Undead and Demon
    <p><b>----------------------------------</b>
    <p><b>Can be done without really trying</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/FactionGrinderSecretTrophy.png" alt="Faction Grinder" align="middle"> <b>Faction Grinder</b> (1M with Elves)
    <p>Purchase the 6 Vanilla Faction Heritage upgrades in a single game.(Without Abdicating)
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/RewindSecretTrophy.png" alt="Rewind" align="middle"> <b>Rewind</b> (100M)
    <p>Abdicate after producing at least 1Oc Coins.
    <p>This is done at the end of R0
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/ArchaeologyExpedition.png" alt="Archaeology Expedition" align="middle"> <b>Archaeology Expedition</b> (1B)
    <p>Excavate once</b>
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/MasterArcheologistSecretTrophy.png" alt="Master Archeologist" align="middle"> <b>Master Archeologist</b> (100B)
    <p>Given once you’ve unlocked Titans, Druids, and Faceless.
    ...
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/UnitarySecretTrophy.png" alt="Unitary" align="middle"> <b>Unitary</b> (1B?)
    <p>Have exactly 1 of each building at any given time.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/FairyChoirSecretTrophy.png" alt="Fairy Choir" align="middle"> <b>Fairy Choir</b> (20Qi, helps for unlocking Dwarves)
    <p>Cast Fairy Chanting (Fairy spell) while having 45 or more assistants.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/GreedDriveSecretTrophy.png" alt="Greed Drive" align="middle"> <b>Greed Drive</b> (takes several hours before R3, or 30 minutes with a Merc build)
    <p>Cast 100 Goblin’s Greed (Goblin spell) while not casting any other spell in a single game.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/LightningStormSecretTrophy.png" alt="LightningStorm" align="middle"> <b>Lightning Storm</b> (takes several hours before R3, or 30 minutes with Merc build)
    <p>Cast Lightning Strike (Titan spell) 100 times in a single game.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/HallsofBalanceSecretTrophy.png" alt="Halls of Balance" align="middle"> <b>Halls of Balance</b> (10T)
    <p>Have Grand Balance (Druid spell) affect Hall of Legends. Buy all buildings except HoL.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/FacelessOvermindSecretTrophy.png" alt="Faceless Overmind" align="middle"> <b>Faceless Overmind</b>
    <p>Affiliate with the Faceless 5 times in a row. (Only need to Buy the Trade Treaty then Abdicate)
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/MinedwarfSecretTrophy.png" alt="Minedwarf" align="middle"> <b>Minedwarf</b>
    <p>Find 30,000 Faction Coins from Diamond Pickaxe (Dwarf spell) in a single game.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/PerfectComboSecretTrophy.png" alt="PerfectCombo" align="middle"> <b>Perfect Combo</b>
    <p>Cast a chain of 100 Combo Strikes (Drow spell) in a single game. The chain is interrupted by casting (clicking spells) different spells.
    <p><b>----------------------------------</b>
    <p><b>Easy to do at the end of R0</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/MathematicianSecretTrophy.png" alt="Mathematician" align="middle"> <b>Mathematician</b> (1Sp with Dwarves)
    <p>This means having 1024 Farms, 512 Inns, 256 Blacksmiths, 128, 64, 32, 16, 8, 4, 2 and 1 Hall of Legends.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/HellRushSecretTrophy.png" alt="Hell Rush" align="middle"> <b>Hell Rush</b> (1Oc?)
    <p>Cast Hellfire Blast (Demon spell) in the first 60 seconds of playtime.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/RealmDiggerSecretTrophy.png" alt="Realm Digger" align="middle"> <b>Realm Digger</b> (1Oc)
    <p>Excavate 400 times.
    <p><b>Note</b>: Do this just before Reincarnating
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/ExchangeMasterSecretTrophy.png" alt="Exchange Master" align="middle"> <b>Exchange Master</b> (1Oc)
    <p>Purchase 500 Royal Exchanges in a single game.
    <p><b>----------------------------------</b></p>
    ...
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/ManaWasteSecretTrophy.png" alt="Mana Waste" align="middle"> <b>Mana Waste</b> (R7+)
    ...
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/BloodstreamSecretTrophy.png" alt="Bloodstream" align="middle"> <b>Bloodstream</b> (R7)
    <p>Unlock all the faction Bloodlines.(Buy at least 100 upgrades from each Faction accross all reincarnations)
    <p><b>----------------------------------</b>
    ...
    <p><b>----------------------------------</b></p>
    <p><b><img src="http://musicfamily.org/realm/Factions/picks/NoviceResearcherSecretTrophy.png" alt="Novice Researcher" align="middle"> Novice Researcher</b> (R16)</p>
    <p>Research 600 times across all fields.</p>
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/ApothecarySecretTrophy.png" alt="Apothecary" align="middle"> <b>Apothecary</b> (R17)
    <p>Discover at least 10 Alchemy Researches.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/VanillaChallengerSecretTrophy.png" alt="Vanilla Challenger" align="middle"> <b>Vanilla Challenger</b> (R18)
    <p>Complete all the Vanilla Challenges.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/ArtisanSecretTrophy.png" alt="Artisan" align="middle"> <b>Artisan</b> (R19)
    <p>Discover at least 10 Craftsmanship Researches.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/MagicianSecretTrophy.png" alt="Magician" align="middle"> <b>Magician</b> (R20)
    <p>Discover at least 10 Spellcraft Researches.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/DemigodSecretTrophy.png" alt="Demigod" align="middle"> <b>Demigod</b> (R20)
    <p>Discover at least 10 Divine Researches.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/BusinessmanSecretTrophy.png" alt="Businessman" align="middle"> <b>Businessman</b> (R20)
    <p>Discover at least 10 Economics Researches.
    <p><b>----------------------------------</b>
    ...
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/VanillaChallengerSecretTrophy.png" alt="Vanilla Challenger" align="middle"> <b>Vanilla Researcher</b> (R22)
    <p>Discover all the Vanilla researches.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/IntermediateResearcherSecretTrophy.png" alt="Intermediate Researcher" align="middle"> <b>Intermediate Researcher</b> (R24)
    <p>Research 1800 times across all fields.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/NeutralChallengerSecretTrophy.png" alt="Neutral Challenger" align="middle"> <b>Neutral Challenger</b> (R25)
    <p>Complete all the Neutral Challenges.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/NoRecruitingSecretTrophy.png" alt="NoRecruiting" align="middle"> <b>No Recruiting</b> (R25) (Can be done at R21)
    <p>Reach 1 NoVg (1e90) gems without affiliating with mercenaries.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/AncientResearcherSecretTrophy.png" alt="Ancient Researcher" align="middle"> <b>Ancient Researcher</b> (R28)
    <p>Discover all the Ancient Races researches.
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/Overgrinder.png" alt="Overgrinder" align="middle"> <b>Overgrinder</b> (R29)
    <p>Build 50,000 Buildings
    <p>You can use this build <a href="http://musicfamily.org/realm/SpecialBuilds/"><b>Overgrinder 50,000 Buildings R29</b></a>
    <p><b>----------------------------------</b>
    ...
    <p>Get 1Oc (1e27) gems in the first game of a reincarnation (currently this is virtually unobtainable R40+).
    <p><b>----------------------------------</b>
    <p><b>5000 Buildings</b> (series 19) (R37+)
    <p>Build 5000 of each building.
    ...
    <p><b>Note</b>: Possible to earn earlier by lagging game.</p>
    <p><b>----------------------------------</b>
    <p><img src="http://musicfamily.org/realm/Factions/picks/GrandmasterResearcherSecretTrophy.png" alt="Grandmaster Researcher" align="middle"><b> Grandmaster Researcher</b> (R79)</p>
