...
<p>This upgrade appears at the 7th reincarnation and requires to have bought a total of 100 "Faction upgrades" of each faction, total across reincarnations. Upgrades such as Trade Treaties, Friendship Pacts, Alliances, Heritages and Spell Upgrades all count towards this.
<p>This upgrade enables to choose a Faction Bloodline, giving a kind of cross-faction perk that resets at abdications.
<p><b>Cost</b>: Free
<p><b>Trophy & Upgrade</b>
...
<p>Unlocking all Faction Bloodlines grants the Bloodstream Secret Trophy, which in turn grants the Bloodstream upgrade.
...
<p><b>Cost</b>:1Tg (1e93 coins)
<p><b>Effect</b>:Increases the production of all buildings based on the total time allied with the faction bloodline you are playing. ('Time Spent Allied with' at the bottom of the stats)
<p><b>Formula</b>:0.1*x^0.65%, where x is your (adjusted) time spent affiliated with the bloodline's faction in seconds.
<p><b>R28+</b></b>:Starting from R28, you might get Bloodspring research upgrade, that will grant you bloodline of the faction you're currently playing, in addition to the bloodline that you have chosen by basic upgrade.
<p><b>----------------------------------</b>
<p><img src="http://musicfamily.org/realm/Factions/picks/FairyBloodline.png" alt="fairy" align="middle"><b> Fairy</b></p>
<p><b>Effect</b>: Increase the production of Farm, Inn and Blacksmith based on the assistants you own.
<p><b>Formula</b>: 250 * x^0.9%, where x is the number of assistants you have.
<p><b>----------------------------------</b>
...
<p>Reduces cost multiplier by 0.02; with no other reductions applying, the multiplier will be 1.13 instead of 1.15.
<p><b>----------------------------------</b>
<p><img src="http://musicfamily.org/realm/Factions/picks/UndeadBloodline.png" alt="Undead" align="middle"><b> Undead</b></p>
<p><b>Effect</b>: Gain additional assistants based on the amount of times you reincarnated.
<p><b>Formula</b>: floor(8*x^0.8), where x is the number of times you have reincarnated.
<p><b>----------------------------------</b>
<p><img src="http://musicfamily.org/realm/Factions/picks/DemonBloodline.png" alt="Demon" align="middle"><b> Demon</b></p>
<p><b>Effect</b>: Increase production bonus from gems based on total time spent being Evil.
<p><b>Formula</b>: floor(0.04 * x^0.8)%, where x is your Time Spent Being Evil (Total) in seconds stat.
<p><b>----------------------------------</b>
<p><img src="http://musicfamily.org/realm/Factions/picks/TitanBloodline.png" alt="Titan" align="middle"><b> Titan</b></p>
<p><b>Effect</b>: Increase the production of all buildings based on the amount of Royal Exchanges you purchased.
<p><b>Formula</b>: 15*x^0.85%, where x is the amount of Royal Exchanges you own.
<p><b>----------------------------------</b>
...
<p><b>Formula</b>: 0.02 * m ^0.95, where m is your maximum mana. (non-linear value)
...
<p><b>Formula</b>: floor(20 * log^3(1 + x)), where x is your Mana Produced (This Game) stat.
<p><b>----------------------------------</b>
<p><img src="http://musicfamily.org/realm/Factions/picks/DwarvenBloodline.png" alt="Dwarf" align="middle"><b> Dwarf</b></p>
<p><b>Effect</b>: Increase the production of all buildings based on the amount of excavations you made.
...
<p><b>Formula</b>: ({1.25 * (x ^ 0.55)}%) x is Faction Coin find chance.
