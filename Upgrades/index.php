...
<map name="bgroup1-map">
    ...
    <area target="" research="<b>Dwarven Forges</b><p>At R29, Blacksmiths can be upgraded to the Unique Building: Dwarven Forges, boosting their production based on mana regeneration and unlocking additional perks related to the building.</p><p><b>Alignment:</b> Good-Dwarf</p><p><b>Unlock Requirements:</b> R29+, 5000 Blacksmiths</p><p><b>Formula:</b> 100 ^ x ^ 0.9, where x is mana per second.</p>" coords="351,111,536,159" shape="rect">
</map>
...
<map name="darktemplesgroup1-map">
    ...
    <area target="" research="<b>Spider Sanctuaries</b><p>At R29, Dark Temples can be upgraded to the Unique Building: Spider Sanctuaries, boosting their production based on time spent offline in this Reincarnation and unlocking additional perks related to the building.</p><p><b>Alignment: </b>Evil Drow</p><p><b>Unlock Requirements:</b> R29+, 3333 Dark Temples</p><p><b>Formula: </b>30 * x ^ 0.8, where x is your Time spent Offline (Total) stat.</p>" coords="351,111,538,161" shape="rect">
</map>
...
<map name="halloflegendsgroup1-map">
    ...
    <area target="" research="<b>Olympian Halls</b><p>At R16, Halls of Legends can be upgraded to the Unique Building: Olympian Halls, boosting their production based on Royal Exchanges count and unlocking additional perks related to the building.</p><p><b>Alignment: </b>Titan</p><p><b>Unlock Requirements:</b> R22+, 200 Halls of Legends</p><p><b>Effect: </b>Grants access to Research Facilities.</p><p><b>Formula: </b>15 * x, where x is Royal Exchanges count.</p>" coords="84,213,268,165" shape="rect">
