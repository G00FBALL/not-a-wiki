...
<p id="end">
<script>
var countDownDate2 = new Date("Sep 30, 2019 18:59:00 UTC").getTime();
var x = setInterval(function() {
    var now = new Date().getTime();
...
<table class="numtable">
        ...
        <tr>
            ...
            <th colspan="5">Total Cumulative Bonus 253%</th>
        </tr>
        </thead>
        <tbody>
        <tr>
    ...
    <area research="Halloween<p><img src=http://musicfamily.org/realm/Factions/picks/Spooky.png align=middle> Spooky<p>Type: Feat<p>Requirements: Collect a full stack of 480 Ectoplasm while using Ghost monster pet." coords="261,233,320,291" shape="rect">
...
<table class="ManaColors" >
        ...
        <tr>
            <td><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleStandard.png" width="54%" height="54%" /></center>
    <center>Standard</center></td>
            <th><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleValentine.png" width="46%" height="46%" /></center>
    <center>Valentine</center></th>
            <th><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleEaster.png" width="43%" height="43%" /></center>
    <center>Easter</center></th>
        </tr>
        <tbody>
        <tr>
            <td><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleBloodwar.png" width="52%" height="52%" /></center>
    <center>Blood War</center></td>
            <td><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleGoblinInvasion.png" width="46%" height="46%" /></center>
    <center>Goblin Invasion</center></td>
            <th><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleSummerFest.png" width="43%" height="43%" /></center>
    <center>Summer Festival</center></th>
        </tr>
        <tr>
            <td><center><center><img src="http://musicfamily.org/realm/Factions/picks/ManaBubbleHalloween.png" width="54%" height="54%" /></center>
