...
<head>
    ...
    <p><b>Offline bonus for spell tier</b>: (m + 100 * r)^(1 + 0.15 * (t)) where m is max mana, r is regen, t is tier. The bonus from each tier suffers A penalties starting the ascension they become availible.</p>
