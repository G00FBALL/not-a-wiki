...
<head>
    ...
    <p><b>Chance</b>: (# Heaven's Gate / 3,750)%</p>
    				" coords="123,103,176,156" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (Consecutive times allied with Angels this R / 60)%</p>
    				" coords="183,103,236,156" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (#Faction Coins this R# / 50,000,000 (50M))%</p>
    				" coords="243,103,296,156" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (Tax collection casts this game / 300,000)%</p>
    				" coords="303,103,356,156" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (# Assistants / 500)%</p>
    				" coords="363,103,416,156" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (Consecutive times allied with Demon this R / 60)%</p>
    				" coords="123,163,176,216" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (Lightning Strike Casts this game / 1,000)%</p>
    				" coords="183,163,236,216" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (Playtime this game / 180,000 (50 Hours))%</p>
    				" coords="243,163,296,216" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: 2%</p>
    				" coords="303,163,356,216" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (Grand Balance Casts this game / 30,000)%</p>
    				" coords="363,163,416,216" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (# clicks this game / 25,000)%</p>
    				" coords="123,223,176,276" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (# Inns / 25,000)%</p>
    				" coords="183,223,236,276" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: 2%</p>
    				" coords="243,223,296,276" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (All-time Evil playtime / 4,320,000 (50 Days))%</p>
    				" coords="303,223,356,276" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (#R / 50)%</p>
    				" coords="363,223,416,276" shape="0">
                    <area research="
    ...
    <p><b>Alignment</b>: Vanilla faction</p>
    				" coords="183,283,236,336" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: 10%</p>
    				" coords="243,283,296,336" shape="0">
                    <area research="
    ...
    <p><b>Alignment</b>: Mercenary</p>
    				" coords="303,283,356,336" shape="0">
                    <area research="
    ...
    <p><b>Alignment</b>: Any</p>
    				" coords="363,283,416,336" shape="0">
                    <area research="
    ...
    <p><b>Cost</b>: 100 Noqag (1e152)</p>
    				" coords="303,343,356,396" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (x / 1,000,000)%, where x is seconds this game.</p>
    				" coords="363,343,416,396" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: ((x - 8,000) / 200,000)%, where x is Wizard Towers built (Building count multipliers do NOT count).</p>
    				" coords="183,403,236,456" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (((3 * x) ^ 4.5) / 10,000)%, where x is free and ruby excavation resets (this game).</p>
    				" coords="243,403,296,456" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (x / 25,920,000 (300 Days))%, where x is angel time (all time) in seconds.</p>
    				" coords="303,403,356,456" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: ((x - 8,000) / 300,000)%, where x is Slave Pens (Building count multipliers do NOT count).</p>
    				" coords="363,403,416,456" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: ((x ^ 2) / 1,500,000,000 (1.5B))%, where x is Royal Exchanges (Royal Exchange count multipliers <b>DO NOT</b> count).</p>
    				" coords="123,463,176,516" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>:  ((x ^ 3) / 2,000,000 (2M))%, where x is level of druid lineage.</p>
    				" coords="183,463,236,516" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: ((x ^ 1.5) / 20,000,000 (20M))%, where x is headstart time in seconds.</p>
    				" coords="243,463,296,516" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (min(x, y, z) / 86,400,000 (1000 Days))%, where x is Fairy Chanting spell activity time, y is Hellfire Blast spell activity time, and z is Brainwave spell activity time (all time).</p>
    				" coords="123,523,176,576" shape="0">
                    <area research="
    ...
    <p><b>Chance</b>: (log10(1 + x) ^ 2 / 6,000)%, where x is FC collected this game.</p>
    				" coords="183,523,236,576" shape="0">
                    <area research="
