...
<head>
    <?php include "../scripts/header.html"; ?>
        <h6><a href="/realm/Factions/"><img src="http://musicfamily.org/realm/Factions/picks/AngelTopPage.png" align="middle"></a></h6>
        ...
        <p><b>Formula</b>: (2.5 * ln(1 + x) ^ 2.5), where x is mana produced.</p>
