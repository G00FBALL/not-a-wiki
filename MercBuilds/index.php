        ...
        <div class="category">
                ...
                <div class="shelementwhole">
                        ...
                        <div class="autohide">
                          ...
                          <p><button onclick="myFunction($(this))">Copy Build</button>
                          <input type="text" value="GB1,UD5,UD7,DM3,TT6,DD1,DD6,DD9,DN3,DN8,DW5,DW8,SP:Fairy Chanting,SP:Grand Balance" id="Build">
                          <p><b>Template</b>: Elven Bloodline
                          <p>GB1,UD5,UD7,DM3,TT6,DD1,DD6,DD9,DN3,DN8,DW5,DW8,
                          <p>SP:Fairy Chanting,SP:Grand Balance
                          <p><b>Note</b>: Replace UD5 with DD5 when under Sunforce Assistant boost.
